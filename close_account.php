...
<div class='main_column column'>
    ...
    Closing your account will hide your profile and all your activitiy from other users.<br><br>
    ...
    <form action="close_account.php" method="post">
        ...
        <input type="submit" name="cancel" id="update_details" value="No, go back" class="info settings_submit"> 
    </form>
</div>