...
<div class="main_column column">
    ...
    <br><h3>Modify the values and click 'Update Details'</h3><br><br>
    ...
    <form action="settings.php" method="post">
        ...
        <input type="submit" name="update_details" id="save_details" value="Update Info" class="info settings_submit">
    </form>
    ...
    <form action="settings.php" method="post">
        ...
        New Password: <input type="password" name="new_password2" id="settings_input"><br>
        <?php 
